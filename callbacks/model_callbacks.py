...
def register_model_callbacks(app):
    ...
    def _update_EEG_plot_model(rerun_model_button, reset_models_button, model_annotate, model_threshold, run_model_bool, use_slider, skip_hoverinfo, annotation_label, show_annotation_labels, show_annotations_only, hide_bad_channels, highlight_model_channels, current_selected_bad_channels, current_fig):
