        ...
        if globals.plotting_data['EEG']:
            ...
            if 'reset-models' in trigger:
                if len(globals.plotting_data['model']) > 0:
                    ...
                    # updated_fig = get_EEG_plot(globals.plotting_data, plotting_data['plot']['x0'], plotting_data['plot']['x1'], annotation_label, use_slider, show_annotations_only, skip_hoverinfo)
