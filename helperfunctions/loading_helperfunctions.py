...
def parse_model_output_file(filename, raw=None):
    ...
    if raw:
        if '.txt' in filename:
            ...
            return model_output, None, None, globals.plotting_data['annotations']['default_model_annotation_label']
        ...
        return None, None, None, globals.plotting_data['annotations']['default_model_annotation_label']
