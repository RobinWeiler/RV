...
def get_EEG_figure(file_name, raw, selected_channel_names, EEG_scale=None, channel_offset=None, model_output=None, model_channels=[], use_slider=False, show_annotations_only=False):
    ...
    fig = get_EEG_plot(plotting_data, globals.x0, globals.x1, use_slider, show_annotations_only)

    return fig

def get_EEG_plot(data_to_plot, x0, x1, use_slider=False, show_annotations_only=False):
    """Generates EEG plots.
