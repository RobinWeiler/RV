...
def run_viewer(eeg_data=None, save_file_path=None, parameters_to_load=None):
    ...
    Args:
        ...
        Possible keys for parameters_to_load: 'username', 'high_pass', 'low_pass', 'reference', 'resampling_rate', 'scale', 'offset', 'segment_size', 'bad_channels', 'annotations'. Defaults to None.
    """
